...
<div class="item-list">
    ...
    <input type="text" v-model="searchForm.gonggaoName"
           ...
           class="layui-input">
                ...
                <div style="position: relative;display: flex;justify-content: space-evenly;flex-wrap: wrap;margin: 0 auto;">
    <div @click="jump('../gonggao/detail.jsp?id='+item.id);" v-for="(item,index) in dataList" :key="index" class="list-item4 list-item3B" style="padding: 0 3px">
        <div style="display: flex;border-style: solid;" class="animation-box"
             :style='{"padding":"10px 0 10px 10px","boxShadow": "#fff 0px 0px 6px","margin":"0 0 10px 0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","borderRadius":"90px 0 0 90px","borderWidth":"5px","borderStyle":"solid"}'>
            <img :style='{"boxShadow":"0 0 0px rgba(255,0,0,.8)","borderColor":"rgba(0,0,0,.3)","borderRadius":"90px 0 0 90px","borderWidth":"0","width":"150px","borderStyle":"solid","height":"150px"}'
                 :src="baseUrl+item.gonggaoPhoto">
            <div style="display: flex;flex-direction: column;justify-content: space-between;min-width: 150px">
                <div :style='{"isshow":true,"padding":"0","margin":"5px 0 0 0","backgroundColor":"rgba(0,0,0,0)","color":"#666","borderRadius":"0","textAlign":"center","width":"100%","fontSize":"16px"}'
                >{{item.gonggaoName}}
                </div>
                <div v-if="item.gonggaoContent" style="height: 70px;overflow: hidden;display: -webkit-box;-webkit-line-clamp: 3; -webkit-box-orient: vertical;"
                     :style='{"padding":"0","margin":"10px 0 0 0","backgroundColor":"rgba(0,0,0,0)","color":"rgba(111, 109, 133, 1)","borderRadius":"0","textAlign":"center","width":"100%","fontSize":"16px"}'
                     v-html="myFilters(item.gonggaoContent)">
                </div>
                <div style="display: flex;justify-content: space-around;" >
                    <span :style='{"padding":"0 10px","boxShadow":"0 0 6px rgba(0,0,0,.3)","margin":"0 5px","borderColor":"var(--publicSubColor)","backgroundColor":"var(--publicSubColor)","color":"rgba(255, 255, 255, 1)","borderRadius":"4px","borderWidth":"0","width":"auto","lineHeight":"18px","fontSize":"12px","text":"新闻动态","borderStyle":"solid"}'>{{item.gonggaoValue}}</span>
                </div>
            </div>
        </div>
    </div>
