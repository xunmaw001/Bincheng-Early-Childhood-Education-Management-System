                            ...
                            <div class="table-responsive mb-3" id="tableDiv">
                                ...
                                <table id="tableId" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th onclick="sort('yonghu_name')">学生姓名<i id="yonghuNameIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('yonghu_phone')">学生手机号<i id="yonghuPhoneIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('yonghu_id_number')">学生身份证号<i id="yonghuIdNumberIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('yonghu_photo')">学生头像<i id="yonghuPhotoIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('sex_types')">性别<i id="sexTypesIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('yonghu_email')">学生邮箱<i id="yonghuEmailIcon" class="fa fa-sort"></i></th>
