...
var centerMenu = [
    ...
    ,{
        name: '缴费',
        url: '../feiyong/list.jsp'
    }
    ,{
        name: '学生考勤',
        url: '../xueshengkaoqin/list.jsp'
    }
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/youerjiaoyuguanlixitong/admin/dist/index.jsp#/login";
