...
<!--/Pre Loader -->
                        ...
                        <div class="widget-area-2 lochana-box-shadow">
                            ...
                            <div class="table-responsive mb-3" id="tableDiv">
                                <div class="col-sm-12">
                                        ...
                                        <label>缴费</label>
                                        <input type="text" id="feiyongNameSearch" placeholder="请输入缴费" aria-controls="tableId" class="form-control form-control-sm">
                                     
                                        <label>缴费类型</label>
                                        <select name="feiyongTypesSelectSearch" id="feiyongTypesSelectSearch" aria-controls="tableId" class="form-control form-control-sm"></select>
                                     
                                        <label>缴费状态</label>
                                        <select name="feiyongZhuangtaiTypesSelectSearch" id="feiyongZhuangtaiTypesSelectSearch" aria-controls="tableId" class="form-control form-control-sm"></select>
                                                                                                                                                
                                                                                                                                                             
                                        <label>班级名称</label>
                                        <input type="text" id="banjiNameSearch" placeholder="请输入班级名称" aria-controls="tableId" class="form-control form-control-sm">
                                                                                                                                                                                                                                                                                                                         
                                        <label>老师姓名</label>
                                        <input type="text" id="laoshiNameSearch" placeholder="请输入老师姓名" aria-controls="tableId" class="form-control form-control-sm">
                                                                                                                                                                                                                                                                                                                                                                                                                                 
                                        <label>学生姓名</label>
                                        <input type="text" id="yonghuNameSearch" placeholder="请输入学生姓名" aria-controls="tableId" class="form-control form-control-sm">
                                        ...
                                        <span class="导入导出">
                                            导入<input name="file" id="feiyongExcelFile" type="file" class="btn btn-success" style="width: 70px!important; line-height: 35px;">
                                            <button class="btn btn-success" onclick="download('/upload/feiyongMuBan.xls')">导入模板下载</button>
                                        </span>
                                ...
                                <table id="tableId" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th>班级编号<i id="banjiUuidNumberIcon"></i></th>
                                        <th>班级名称<i id="banjiNameIcon"></i></th>
                                        <th>老师姓名<i id="laoshiNameIcon"></i></th>
                                        <th>老师手机号<i id="laoshiPhoneIcon"></i></th>
                                        <th>老师头像<i id="laoshiPhotoIcon"></i></th>
                                        <th>学生姓名<i id="yonghuNameIcon"></i></th>
                                        <th>学生手机号<i id="yonghuPhoneIcon"></i></th>
                                        <th>学生头像<i id="yonghuPhotoIcon"></i></th>
                                        <th>余额<i id="newMoneyIcon"></i></th>
                                        <th onclick="sort('feiyong_name')">缴费<i id="feiyongNameIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('feiyong_types')">缴费类型<i id="feiyongTypesIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('feiyong_zhuangtai_types')">缴费状态<i id="feiyongZhuangtaiTypesIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('feiyong_old_money')">缴费金额<i id="feiyongOldMoneyIcon" class="fa fa-sort"></i></th>
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //缴费
            var feiyongNameSearchInput = $('#feiyongNameSearch');
            if( feiyongNameSearchInput != null){
                if (feiyongNameSearchInput.val() != null && feiyongNameSearchInput.val() != '') {
                    searchForm.feiyongName = $('#feiyongNameSearch').val();
                }
            }
            ...
            if(feiyongTypesSelectSearchInput != null){
                ...
                //缴费状态
            var feiyongZhuangtaiTypesSelectSearchInput = document.getElementById("feiyongZhuangtaiTypesSelectSearch");
            if(feiyongZhuangtaiTypesSelectSearchInput != null){
                var feiyongZhuangtaiTypesIndex = feiyongZhuangtaiTypesSelectSearchInput.selectedIndex;
                if( feiyongZhuangtaiTypesIndex  != 0){
                    searchForm.feiyongZhuangtaiTypes= document.getElementById("feiyongZhuangtaiTypesSelectSearch").options[feiyongZhuangtaiTypesIndex].value;
                }
            }
                            getDataList();
        }
        ...
        function getDataList() {
            http("feiyong/page", "GET", {
                ...
                feiyongDelete: 1,
                //本表的
                feiyongName: searchForm.feiyongName,
                feiyongTypes: searchForm.feiyongTypes,
                feiyongZhuangtaiTypes: searchForm.feiyongZhuangtaiTypes,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            row.appendChild(checkbox)
                    ...
                    //班级编号
            var banjiUuidNumberCell = document.createElement('td');
            banjiUuidNumberCell.innerHTML = item.banjiUuidNumber;
            row.appendChild(banjiUuidNumberCell);
            ...
            //缴费
            var feiyongNameCell = document.createElement('td');
            feiyongNameCell.innerHTML = item.feiyongName;
            row.appendChild(feiyongNameCell);
            ...
            //缴费状态
            var feiyongZhuangtaiTypesCell = document.createElement('td');
            feiyongZhuangtaiTypesCell.innerHTML = item.feiyongZhuangtaiValue;
            row.appendChild(feiyongZhuangtaiTypesCell);


            //缴费金额
            var feiyongOldMoneyCell = document.createElement('td');
            feiyongOldMoneyCell.innerHTML = item.feiyongOldMoney;
            row.appendChild(feiyongOldMoneyCell);
        ...
        function upload() {
            /*导入数据*/
            $('#feiyongExcelFile').fileupload({
                url: baseUrl + 'file/upload',
                headers: {token: window.sessionStorage.getItem("token")},
                dataType: "json",
                done: function (e, data) {
                    http("feiyong/batchInsert?fileName="+data.result.file, "get", {} , (res) => {
                        if(res.code == 0){
    ...
    //填充本表搜索下拉框
        ...
        function feiyongZhuangtaiTypesSelectSearch() {
            var feiyongZhuangtaiTypesSelectSearch = document.getElementById('feiyongZhuangtaiTypesSelectSearch');
            if(feiyongZhuangtaiTypesSelectSearch != null) {
                feiyongZhuangtaiTypesSelectSearch.add(new Option('-请选择-',''));
                if (feiyongZhuangtaiTypesOptions != null && feiyongZhuangtaiTypesOptions.length > 0){
                    for (var i = 0; i < feiyongZhuangtaiTypesOptions.length; i++) {
                            feiyongZhuangtaiTypesSelectSearch.add(new Option(feiyongZhuangtaiTypesOptions[i].indexName,feiyongZhuangtaiTypesOptions[i].codeIndex));
                    }
                }
            }
        }
