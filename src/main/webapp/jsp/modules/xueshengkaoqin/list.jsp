...
<!--/Pre Loader -->
                        ...
                        <div class="widget-area-2 lochana-box-shadow">
                            ...
                            <div class="table-responsive mb-3" id="tableDiv">
                                <div class="col-sm-12">
                                        ...
                                        <label>考勤结果</label>
                                        <select name="xueshengkaoqinTypesSelectSearch" id="xueshengkaoqinTypesSelectSearch" aria-controls="tableId" class="form-control form-control-sm"></select>
                                        ...
                                        <span class="导入导出">
                                            导入<input name="file" id="xueshengkaoqinExcelFile" type="file" class="btn btn-success" style="width: 70px!important; line-height: 35px;">
                                            <button class="btn btn-success" onclick="download('/upload/xueshengkaoqinMuBan.xls')">导入模板下载</button>
                                        </span>
                                ...
                                <table id="tableId" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th onclick="sort('xueshengkaoqin_types')">考勤结果<i id="xueshengkaoqinTypesIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('kaoqin_time')">考勤日期<i id="kaoqinTimeIcon" class="fa fa-sort"></i></th>
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            if( yonghuNameSearchInput != null){
                ...
                //考勤结果
            var xueshengkaoqinTypesSelectSearchInput = document.getElementById("xueshengkaoqinTypesSelectSearch");
            if(xueshengkaoqinTypesSelectSearchInput != null){
                var xueshengkaoqinTypesIndex = xueshengkaoqinTypesSelectSearchInput.selectedIndex;
                if( xueshengkaoqinTypesIndex  != 0){
                    searchForm.xueshengkaoqinTypes= document.getElementById("xueshengkaoqinTypesSelectSearch").options[xueshengkaoqinTypesIndex].value;
                }
            }
                            getDataList();
        }
        ...
        function getDataList() {
            http("xueshengkaoqin/page", "GET", {
                page: pageIndex,
                limit: pageSize,
                sort: sortColumn,//字段
                order: sortOrder,//asc desc
                xueshengkaoqinDelete: 1,
                //本表的
                xueshengkaoqinTypes: searchForm.xueshengkaoqinTypes,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //考勤结果
            var xueshengkaoqinTypesCell = document.createElement('td');
            xueshengkaoqinTypesCell.innerHTML = item.xueshengkaoqinValue;
            row.appendChild(xueshengkaoqinTypesCell);


            //考勤日期
            var kaoqinTimeCell = document.createElement('td');
            kaoqinTimeCell.innerHTML = item.kaoqinTime;
            row.appendChild(kaoqinTimeCell);
        ...
        function upload() {
            /*导入数据*/
            $('#xueshengkaoqinExcelFile').fileupload({
                url: baseUrl + 'file/upload',
                headers: {token: window.sessionStorage.getItem("token")},
                dataType: "json",
                done: function (e, data) {
                    http("xueshengkaoqin/batchInsert?fileName="+data.result.file, "get", {} , (res) => {
                        if(res.code == 0){
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("xueshengkaoqin/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
        ...
        function wuyong(id) {
            ...
            if (mymessage == true) {
                httpJson("xueshengkaoqin/update", "POST", {
                    id:id,
                    xueshengkaoqinTypes:2
                }, (res) => {
                    if(res.code == 0){
                        getDataList();
                        layui.layer.msg("操作成功", {time: 2000,icon: 6});
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addxueshengkaoqin", "addxueshengkaoqin");
            window.location.href = "add-or-update.jsp"
        }
    ...
    //填充本表搜索下拉框
        ...
        function xueshengkaoqinTypesSelectSearch() {
            var xueshengkaoqinTypesSelectSearch = document.getElementById('xueshengkaoqinTypesSelectSearch');
            if(xueshengkaoqinTypesSelectSearch != null) {
                xueshengkaoqinTypesSelectSearch.add(new Option('-请选择-',''));
                if (xueshengkaoqinTypesOptions != null && xueshengkaoqinTypesOptions.length > 0){
                    for (var i = 0; i < xueshengkaoqinTypesOptions.length; i++) {
                            xueshengkaoqinTypesSelectSearch.add(new Option(xueshengkaoqinTypesOptions[i].indexName,xueshengkaoqinTypesOptions[i].codeIndex));
                    }
                }
            }
        }
