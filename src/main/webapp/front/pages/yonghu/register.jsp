...
<form class="layui-form login-form" lay-filter="myForm"
      style="padding: 15px;box-shadow: 0 0 6px rgba(255,0,0,.1);background-color: #fff;border-width: 30px;width: 500px;border-radius: 20px;border-style: solid;border-color: #fff;height: 600px;">

    <div style="position: sticky;top: 0;height: 40px;background-color: #fff;">
        <p class="title" v-if="true"
           :style='{"padding":"0 10px","boxShadow":"0 0 0px rgba(255,0,0,.8)","margin":"10px auto","borderColor":"rgba(0,0,0,1)","backgroundColor":"rgba(247, 247, 247, 0)","color":"var(--publicMainColor)","isshow":true,"borderRadius":"8px","borderWidth":"0","width":"110px","lineHeight":"32px","fontSize":"17px","borderStyle":"solid"}'>
            学生注册</p>
    </div>
        ...
        <!-- 身份证号 -->
            <div :style='{"padding":"0","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0 auto","borderColor":"rgba(0,0,0,1)","borderRadius":"0","borderWidth":"0 0 1px 0","width":"80%","borderStyle":"solid","height":"64px"}'
                ...
                <input :style='{"padding":"0 10px","boxShadow":"0 0 6px var(--publicMainColor)","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"rgba(59, 46, 126, 1)","borderRadius":"8px","textAlign":"left","borderWidth":"1px","width":"100%","fontSize":"14px","borderStyle":"solid","height":"44px"}'
                       ...
                       name="yonghuIdNumber" placeholder="请输入学生身份证号"
                       autocomplete="off" class="layui-input">
            </div>
                        <div :style='{"padding":"0","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0 auto","borderColor":"rgba(0,0,0,1)","borderRadius":"0","borderWidth":"0 0 1px 0","width":"80%","borderStyle":"solid","height":"64px"}'
