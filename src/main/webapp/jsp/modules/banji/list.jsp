...
<!--/Pre Loader -->
                        ...
                        <div class="widget-area-2 lochana-box-shadow">
                            ...
                            <div class="table-responsive mb-3" id="tableDiv">
                                <div class="col-sm-12">
                                        ...
                                        <span class="导入导出">
                                            导入<input name="file" id="banjiExcelFile" type="file" class="btn btn-success" style="width: 70px!important; line-height: 35px;">
                                            <button class="btn btn-success" onclick="download('/upload/banjiMuBan.xls')">导入模板下载</button>
                                        </span>
                                ...
                                <table id="tableId" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th onclick="sort('banji_uuid_number')">班级编号<i id="banjiUuidNumberIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('banji_name')">班级名称<i id="banjiNameIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('banji_address')">班级位置<i id="banjiAddressIcon" class="fa fa-sort"></i></th>
    ...
    <!-- 本表的查询条件 -->
        ...
        function setDataRow(item, number) {
            ...
            //班级位置
            var banjiAddressCell = document.createElement('td');
            banjiAddressCell.innerHTML = item.banjiAddress;
            row.appendChild(banjiAddressCell);
        ...
        function upload() {
            /*导入数据*/
            $('#banjiExcelFile').fileupload({
                url: baseUrl + 'file/upload',
                headers: {token: window.sessionStorage.getItem("token")},
                dataType: "json",
                done: function (e, data) {
                    http("banji/batchInsert?fileName="+data.result.file, "get", {} , (res) => {
                        if(res.code == 0){
