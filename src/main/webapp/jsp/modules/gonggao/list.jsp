                        ...
                        <div class="widget-area-2 lochana-box-shadow">
                            ...
                            <div class="table-responsive mb-3" id="tableDiv">
                                <div class="col-sm-12">
                                        ...
                                        <label>新闻名称</label>
                                        <input type="text" id="gonggaoNameSearch" placeholder="请输入新闻名称" aria-controls="tableId" class="form-control form-control-sm">
                                ...
                                <table id="tableId" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th onclick="sort('gonggao_name')">新闻名称<i id="gonggaoNameIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('gonggao_photo')">新闻图片<i id="gonggaoPhotoIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('gonggao_types')">新闻类型<i id="gonggaoTypesIcon" class="fa fa-sort"></i></th>
