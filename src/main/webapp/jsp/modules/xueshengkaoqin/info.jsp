                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <div class="form-group col-md-6">
                                    <label>考勤结果</label>
                                    <input style="width: 450px" id="xueshengkaoqinValue" name="xueshengkaoqinValue" class="form-control"
                                           v-model="ruleForm.xueshengkaoqinValue" readonly>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>考勤日期</label>
                                        <input style="width: 450px" id="kaoqinTime" name="kaoqinTime" class="form-control"
                                               v-model="ruleForm.kaoqinTime" readonly>
                                    </div>
...
<script>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "xueshengkaoqin/info/" + id,
    ...
    function setContent() {
        ...
        if (ruleForm.xueshengkaoqinContent != null && ruleForm.xueshengkaoqinContent != 'null' && ruleForm.xueshengkaoqinContent != '') {
            var xueshengkaoqinContentUeditor = UE.getEditor('xueshengkaoqinContentEditor');
                xueshengkaoqinContentUeditor.ready(function () {
                    ...
                    xueshengkaoqinContentUeditor.setDisabled('fullscreen');
            });
        }
    }
