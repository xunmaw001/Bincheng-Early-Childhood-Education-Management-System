                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="banjiId" name="banjiId" v-model="ruleForm.banjiId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="feiyongName" name="feiyongName" class="form-control"
                                               v-model="ruleForm.feiyongName" readonly>
                                    </div>
                                ...
                                <div class="form-group col-md-6">
                                    <label>缴费状态</label>
                                    <input style="width: 450px" id="feiyongZhuangtaiValue" name="feiyongZhuangtaiValue" class="form-control"
                                           v-model="ruleForm.feiyongZhuangtaiValue" readonly>
                                </div>

                                    <div class="form-group col-md-6">
                                        <label>缴费金额</label>
                                        <input style="width: 450px" id="feiyongOldMoney" name="feiyongOldMoney" class="form-control"
                                               v-model="ruleForm.feiyongOldMoney" readonly>
                                    </div>
